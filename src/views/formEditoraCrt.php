...
<body class="background-dark-light">
    ...
    <div class="container w-100 mx-auto mt-4">
        ...
        <div class="border-warning bg-dark text-white mx-auto p-4 rounded-4 order-1 order-lg-2 mt-4">
            <form id="editoraForm" method="POST" action="../controllers/editoraController.php?acao=inserir" class="row row-cols-1 row-cols-md-2 text-start mx-md-3">
                ...
                <div class="col-md-10 form-floating col mb-3">
                    <input type="text" class="form-control text-white background-dark-light border-bottom border-top-0 border-start-0 border-end-0 border-3 rounded-bottom-0 border-warning me-2" id="nome" name="nome" placeholder="Nome" maxlength="50" required>
