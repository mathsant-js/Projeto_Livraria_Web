...
<body class="background-dark-light">
    ...
    <div class="container w-100 mx-auto mt-5 pt-5">
        <div class="border-warning bg-dark text-white mx-auto p-4 rounded-4 order-1 order-lg-2">
            <form class="row row-cols-1 row-cols-md-2 text-start mx-md-3">
                <h2 class="text-warning ms-md-3 mb-4 w-100">Dados de Gêneros</h2>
                ...
                <div class="col-md-12 form-floating col mb-4">
                    <input type="text" class="form-control text-warning background-dark-light border-bottom border-top-0 border-start-0 border-end-0 border-3 rounded-bottom-0 border-warning me-2" id="descricao" name="descricao" placeholder="Descrição" required>
